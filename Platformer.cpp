...
int main()
{
	...
	Object Wall;
	Wall.setObject(Vector2f(800, 20), Color::Red, Point::Default);
	Wall.setPosition(200, 600);

	Object Wall2;
	Wall2.setObject(Vector2f(20, 600), Color::Red, Point::Default);
	Wall2.setPosition(1000, 20);

	Object Cube;
	Cube.setObject(Vector2f(100, 100), Color::Red,Point::Default);
	...
	Object ObPlayer;
	ObPlayer.setObject(Vector2f(32, 32), Color::Transparent, Point::Centre);
